    ...
    <>
       ...
       <div className='d-flex flex-wrap container justify-content-around carss'>
           ...
           <div className="div">
                   ...
                   <p className=" ">The  Mercedes Vito Tourer is a versatile van with seating for 6 Offering advanced safety features and a comfortable interior, ideal for business or family use.</p>
       ...
       <div className='container car_section mb-5'>
        ...
        <div>
        <img className='rounded ' id='swift_car' src={img4} alt='img'/>
