...
<div className='chauffer_bg'>

<h1 className='text-white fw-bolder text-uppercase about text-center ps-3 pe-3 ' id='heading_bg'>Premium Chauffeur Cab Services in Auckland
  ...
  <div className='col-1 text-center'> </div>
    ...
    <div  className='col-5  text-center'>
      <h1 className='movie_h1'>Premium Chauffeur Cab Services in Auckland
  ...
  <div className='container highlight' >
   ...
   <h4  className='fw-bolder '>Why Choose Our Chauffeur Cab Services?
   ...
   <h6 className='mt-4 mb-4'><span className="fw-bolder">Personalized Service:</span> From door-to-door service to route customization, our chauffeurs tailor each ride to meet your specific needs and preferences. </h6>

   <h6 className='mt-4 mb-4'><span className="fw-bolder"> Discreet and Confidential:</span>Whether it’s a business meeting or a private event, our chauffeurs offer complete discretion, ensuring your privacy at all times.</h6>

   <h6 className='mt-4 mb-4'><span className="fw-bolder">     Round-the-Clock Availability: </span>Our chauffeur services are available 24/7, ready to assist you with your travel needs, whether it’s early morning flights or late-night events.
   </h6>
   ...
   <h4  className='fw-bolder  mb-3' style={{"marginTop":"5rem"}}>Services We Offer
   ...
   <h4  className='fw-bolder  mb-3' style={{"marginTop":"5rem"}}>How It Works
   ...
   <h6 className='mt-4 mb-4'><span className="fw-bolder">   3. On-Time Pickup: </span>our chauffeur will arrive on time at your specified location, ready to assist with luggage and ensure a comfortable journey.
   </h6>
   <h6 className='mt-4 mb-4'><span className="fw-bolder">   4. Enjoy Your Ride: </span> Sit back and relax while our chauffeur takes care of everything, from navigating traffic to ensuring a smooth, luxurious ride.
   </h6>
   ...
   <h4  className='fw-bolder  mb-3' style={{"marginTop":"5rem"}}>Why We're Auckland's Preferred Chauffeur Service
   ...
   <h6 className='mt-4 mb-4'><span className="fw-bolder">  1.  Unmatched Luxury and Comfort: </span> We provide an unparalleled level of comfort and sophistication, ensuring a premium experience with every ride.
   </h6>
   <h6 className='mt-4 mb-4'><span className="fw-bolder">  2. Attention to Detail:   </span> From customized routes to complimentary in-car amenities like bottled water and Wi-Fi, we go the extra mile to ensure your journey is flawless.

   </h6>
   <h6 className='mt-4 mb-4'><span className="fw-bolder">   3.  24/7 Customer Support: </span>Our dedicated customer service team is available around the clock to assist with any special requests or last-minute changes.
   </h6>
   ...
   <h4  className='fw-bolder  mb-3' style={{"marginTop":"5rem"}}>Book Your Chauffeur Today
